...
namespace AzureTools.Client
{
    public static class Endpoints
    {
        ...
        public static string UsersEndpoint => $"/{BetaVersion}/users?select=id,userPrincipalName,accountEnabled,riskLevel,assignedRoles,authenticationMethods,mail,displayName,givenName,surname,jobTitle,mobilePhone,officeLocation,businessPhones";
