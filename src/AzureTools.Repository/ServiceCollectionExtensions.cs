...
namespace AzureTools.Repository
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Adds the necessary services to the <see cref="IServiceCollection"/> for Kusto repository support.
        /// </summary>
        /// <param name="services">The <see cref="IServiceCollection"/>.</param>
        /// <param name="config">The <see cref="IConfiguration"/> to get the correct settings.</param>
        /// <returns>The <see cref="IServiceCollection"/>.</returns>
        public static IServiceCollection AddKustoRepository(this IServiceCollection services, IConfiguration config)
        {
            services.Configure<KustoSettings>(config.GetSection(KustoSettings.ConfigurationSectionName));
            services.Configure<RepositorySettings>(config.GetSection(RepositorySettings.ConfigurationSectionName));
            ...
            services.AddSingleton<IObjectRepository, KustoRepository>();
            return services;
        }
    }
}
